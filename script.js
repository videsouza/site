  ...
  books: [
    {
      ...
      year: 2024,
      publisher: "Editora X",
      cover: "", // URL da imagem da capa, ou deixe vazio
  ...
  articles: [
    {
      ...
      type: "Periódico", // ou "Capítulo", "Anais", "Ensaios"
      link: "#"
    },
    {
...
function renderPoems() {
  ...
  document.querySelectorAll('.poem-item').forEach(item => {
    item.addEventListener('click', () => {
      ...
      showPoem(parseInt(item.dataset.index, 10));
    });
  });
}
